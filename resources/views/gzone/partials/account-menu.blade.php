<div class="account-menu"><a class="account-menu-link" href="{{route('profile.bookmark.index')}}">
        <svg class="icon icon-bookmark ">
            <use xlink:href="{{asset("./images/sprite-inline.svg#bookmark")}}"></use>
        </svg>Мои закладки</a><a class="account-menu-link account-menu-link" href="{{route('profile.history.index')}}">
    ...
    <hr><a class="account-menu-link" href="{{route('profile.settings')}}">
        <svg class="icon icon-setting ">
            <use xlink:href="{{asset("./images/sprite-inline.svg#setting")}}"></use>
        </svg>Настройки аккаунта</a><a class="account-menu-link" href="{{route('logout')}}">
